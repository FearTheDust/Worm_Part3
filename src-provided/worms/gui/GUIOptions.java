...
public class GUIOptions {
     ...
     *
     * Full screen can also be disabled from the command line by providing the
     * -window argument
     */
    public boolean disableFullScreen = false;

    /**
     * Random seed for the game Default: 3
     *
    ...
    /**
     * Enable quick worm selection by clicking the mouse Default: false
     *
    ...
    /**
     * The program that is executed by computer-controlled worms. Default:
